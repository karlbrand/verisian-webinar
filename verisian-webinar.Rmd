...
## Disclaimer
<br />
There are no contracts for payment, draft or otherwise between myself or my employer and Verisian.
<br />
<br />
The written and expressed views in this presentation are entirely those of the presenter; they are not intended to be representative in any way of my employer, Bayer Aktiengesellschaft.
...
d. Challenges unique to the Domain (data privacy), Silo everything: Data and code and tools are closed source
<!-- :wave: -->
<!-- ::: -->
...
b. Agile development: collaboration, iteration, open-ish source (democratize the (mostly open source) tools and processes)
c. Make it all accessible to any-one (data scientist, shareholder, regulator), any-time, any-how
